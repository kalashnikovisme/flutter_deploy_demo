...
import 'package:test_intern/src/presentation/pages/home_page.dart';
import 'package:test_intern/src/presentation/pages/widget/no_internet_widget.dart';
                ...
                children: [
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      labelText: AppLocalizations.of(context)?.stringEmail ?? '',
                  ...
                  Column(
                    children: [
                      ElevatedButton(
                        ...
                        child: Text(AppLocalizations.of(context)?.registerString ?? ''),
                      ),
                      ElevatedButton(
                        onPressed: () {
                          final email = emailController.text;
                        ...
                        child: Text(AppLocalizations.of(context)?.signInString ?? ''),
                      ),
                    ],
                  ),
                ],
